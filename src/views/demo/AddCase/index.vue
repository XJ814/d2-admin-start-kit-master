  ...
  <d2-container>
    <div class="subject">
      ...
      <div class="subject_header">
        ...
        <span class="subject_header_text2" @click="add">
      ...
      <div class="subject_middle">
        ...
        <div class="medicalDetail_con_mid1">
          ...
          <div class="detail_con_left_side_row diseaseDes_wrap">
            ...
            <textarea
              class="detail_inp11 diseaseTextarea"
              v-model="details[0].disease"
              :disabled="!isEidt"
              placeholder="请输入病症"
            ></textarea>
          </div>
        ...
        <div class="medicalDetail_con_side2">
          <div>
            <p>用量详情</p>
            <textarea
              class="detail_inp12 diseaseTextarea"
              v-model="details[0].medicine"
              :disabled="!isEidt"
              placeholder="请输入用量详情"
            ></textarea>
          </div>
